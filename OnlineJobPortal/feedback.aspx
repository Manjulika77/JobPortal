<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="feedback.aspx.cs" Inherits="OnlineJobPortal.feedback" %>
...
<asp:TextBox name="name" ID="name" class="form-control" data-error="Please enter your name" placeholder="Your Full Name" runat="server"></asp:TextBox>
...
<div class="col-sm-6 col-lg-6">
<div class="form-group">
<asp:TextBox name="email" ID="email" TextMode="Email" class="form-control" data-error="Please enter your email" placeholder="Your Email" runat="server"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="email" ErrorMessage="Phone Number is required!" ForeColor="Red"></asp:RequiredFieldValidator>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-sm-6 col-lg-12">
<div class="form-group">
<asp:TextBox name="phone_number" ID="phone_number" data-error="Please enter your number" class="form-control" placeholder="Your Phone" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="phone_number" ErrorMessage="Phone Number is required!" ForeColor="Red"></asp:RequiredFieldValidator>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12 col-lg-12">
<div class="form-group">
<asp:TextBox ID="message" class="form-control" TextMode="Multiline" Rows="6" data-error="Write your feedback" placeholder="Your Feedback" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="message" ErrorMessage="Feedback is required!" ForeColor="Red"></asp:RequiredFieldValidator>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12 col-lg-12">
<div class="text-center">
<asp:Button ID="Button1" class="btn contact-btn" runat="server" Text="Submit" OnClick="Button1_Click" />
</div>
<div>
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#4e262b2222210e292f2c222b602d2123">
<span class="__cf_email__" data-cfemail="2b434e4747446b4c4a49474e05484446">[email&#160;protected]</span>
</a>
</li>
</ul>
</div>
