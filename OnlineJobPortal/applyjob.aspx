<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="applyjob.aspx.cs" Inherits="OnlineJobPortal.applyjob" %>
...
<label style="color: #22088d;font-family:Calibri;font-weight:bold">Upload Your CV</label>
<asp:FileUpload ID="FileUpload1" class="form-control-file" style="color:dodgerblue;" runat="server" />
</div>
<div class="row">
<div class="col-lg-6">
<div class="form-group">
<label>Job ID</label>
<asp:TextBox ID="TextBox9" class="form-control" readOnly="true" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<asp:TextBox ID="TextBox3"  class="form-control" TextMode="Phone" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<label>Date of Birth</label>
<asp:TextBox ID="TextBox4" class="form-control" placeholder="mm/dd/yyyy" Textmode="Date" ReadOnly = "false" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<div class="col-lg-6">
<div class="form-group">
<label>Salary Requirement (LPA)</label>
...
<div class="text-left">
<asp:Button ID="Button1" class="btn create-ac-btn" runat="server" Text="Apply Job" OnClick="Button1_Click" />
