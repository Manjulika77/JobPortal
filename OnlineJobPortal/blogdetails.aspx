<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="blogdetails.aspx.cs" Inherits="OnlineJobPortal.blogdetails" %>
...
<li class="nav-item">
<a href="blogdetails.aspx" class="nav-link active">Blog Details</a>
</li>
</ul>
</li>
<li class="nav-item">
...
<asp:TextBox ID="TextBox5" class="form-control" placeholder="Enter Your Email" name="EMAIL" runat="server"></asp:TextBox>
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#83ebe6efefecc3e4e2e1efe6ade0ecee">
<span class="__cf_email__" data-cfemail="dcb4b9b0b0b39cbbbdbeb0b9f2bfb3b1">[email&#160;protected]</span>
</a>
</li>
</ul>
</div>
