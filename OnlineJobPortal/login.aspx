<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="OnlineJobPortal.login" %>
...
<asp:TextBox ID="TextBox1" class="form-control" placeholder="Username or Email" runat="server"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"   
ControlToValidate="TextBox1" ErrorMessage="Please Enter Your Username or Email"   
...
<asp:Button ID="Button1" class="btn login-btn" runat="server" Text="Sign In" OnClick="Button1_Click" />
