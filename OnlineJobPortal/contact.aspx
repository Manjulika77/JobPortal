...
<div class="col-sm-6 col-lg-6">
<div class="form-group">
<asp:TextBox name="email" ID="email" class="form-control" data-error="Please enter your email" placeholder="Your Email" runat="server"></asp:TextBox>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-sm-6 col-lg-6">
...
<div class="col-sm-6 col-lg-6">
<div class="form-group">
<asp:TextBox name="msg_subject" ID="msg_subject" class="form-control" data-error="Please enter your subject" placeholder="Subject" runat="server"></asp:TextBox>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12 col-lg-12">
<div class="form-group">
<asp:TextBox ID="message" name="message" class="form-control" TextMode="Multiline" Rows="6" data-error="Write your message" placeholder="Your Message" runat="server"></asp:TextBox>
<div class="help-block with-errors"></div>
</div>
</div>
<div class="col-md-12 col-lg-12">
