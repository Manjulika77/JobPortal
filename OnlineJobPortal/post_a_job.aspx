<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="post_a_job.aspx.cs" Inherits="OnlineJobPortal.post_a_job" %>
...
<li class="nav-item">
<a href="post_a_job.aspx" class="nav-link active">Post A Job</a>
</li>
</ul>
</li>
<li class="nav-item">
...
<asp:Table ID="Table1" class="form-control" placeholder="UX/UI Designer" runat="server"></asp:Table>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<asp:Table ID="Table2" class="form-control" placeholder="Winbrans.com" runat="server"></asp:Table>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<label>Company Name</label>
<input type="text" class="form-control" placeholder="Winbrans.com"> 
<asp:Table ID="Table3" class="form-control" placeholder="Winbrans.com" runat="server"></asp:Table>
<select class="form-select" aria-label="Default select example">
<option>$USD</option>
<option>EURO</option>
<option>POUND</option>
...
<asp:Table ID="Table4" class="form-control" placeholder="10" runat="server"></asp:Table>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<asp:Table ID="Table5" class="form-control" placeholder="210-27 Quadra, Market Street, Victoria Canada" runat="server"></asp:Table>
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
...
<asp:TextBox ID="TextBox1" rows="8" class="form-control" runat="server"></asp:TextBox>
</div>
</div>
</div>
<div class="text-left">
<button type="submit" class="btn create-ac-btn">Post</button> 
<asp:Button ID="Button1" class="btn create-ac-btn" runat="server" Text="Post" />
</div>
</div>
</div>
</div>
...
<asp:TextBox ID="TextBox2" class="form-control" placeholder="Enter Your Email" name="EMAIL" runat="server"></asp:TextBox>
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#4a222f2626250a2d2b28262f64292527">
<span class="__cf_email__" data-cfemail="563e333a3a39163137343a337835393b">[email&#160;protected]</span>
</a>
</li>
</ul>
</div>
...
<!-- Mirrored from templates.hibootstrap.com/gable/default/post-a-job.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 25 Jun 2021 07:01:05 GMT -->
</html>