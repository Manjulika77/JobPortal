<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="createaccount.aspx.cs" Inherits="OnlineJobPortal.createaccount" %>
...
<li class="nav-item">
<a href="createaccount.aspx" class="nav-link active">Create Account Page</a>
</li>
<li class="nav-item">
...
<div class="form-group">
<asp:TextBox ID="TextBox1" class="form-control" placeholder="Your User Name Here" runat="server"></asp:TextBox>
</div>
<div class="form-group">
<asp:TextBox ID="TextBox2"  class="form-control" TextMode="Password" placeholder="Your Password Here" runat="server"></asp:TextBox>
</div>
<div class="form-group">
<asp:TextBox ID="TextBox3"  class="form-control" TextMode="Password" placeholder="Confirm Password" runat="server"></asp:TextBox>
</div>
</div>
</div>
</div>
...
<asp:TextBox ID="TextBox6" class="form-control" placeholder="mm/dd/yyyy" Textmode="Date" ReadOnly = "false" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
<label>Your Phone</label>
<asp:TextBox ID="TextBox7"  class="form-control" TextMode="Phone" runat="server"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<asp:TextBox ID="Description" TextMode="MultiLine" class="form-control" rows="8" runat="server"></asp:TextBox>
</div>
</div>
</div>
</div>
<div class="text-left">
<asp:Button ID="Button1" class="btn create-ac-btn" runat="server" Text="Create Account" OnClick="Button1_Click" />
</div>
</div>
</div>
...
<asp:TextBox ID="TextBox10" class="form-control" placeholder="Enter Your Email" runat="server"></asp:TextBox>
<asp:Button ID="Button3" class="btn subscribe-btn" style="top: -8px;right:-13px;" runat="server" Text="Subscribe" />
...
<a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#cda5a8a1a1a28daaacafa1a8e3aea2a0">
<span class="__cf_email__" data-cfemail="630b060f0f0c230402010f064d000c0e">[email&#160;protected]</span>
</a>
</li>
</ul>
</div>
